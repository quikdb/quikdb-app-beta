    ...
    return (
        <div className="mt-10">
            ...
            <div className="flex flex-col gap-5">
                ...
                {!isEditing ?
                    <Button className="w-fit bg-transparent border border-[#40E39D] text-[#40E39D]" onClick={() => setIsEditing(true)}>Edit organization roles</Button>
                    :
                    <div>
                        ...
                        <div className="flex gap-4 mt-5">
                            ...
                            <Button size="lg" variant="outline" className="bg-transparent text-[#40E39D] w-fit px-4 border-[#242527]" onClick={() => setIsEditing(false)}>
                                Cancel
                            </Button>
                        </div>
                    </div>
            ...
            <div>
                ...
                <p className="text-gray-400 text-sm">We recommend that you enable Multi-Factor Authentication (MFA) to add extra layer of security to your Couchbase Capella account. </p>
            </div>
            ...
            <div className="flex flex-col gap-5">
                <div>
                    ...
                    <p className="text-gray-400 text-sm">Lorem ipsum dolor sit amet consectetur. Aliquet vitae sapien tristique mauris lacinia molestie. Bibendum in volutpat euismod risus auctor aenean mauris sed. Sit tellus egestas sed ac cursus nunc nisl egestas vestibulum. Aliquam pretium amet adipiscing scelerisque vitae.</p>
                </div>
