  ...
  return (
    <div className='flex justify-center items-center w-full'>
      <div className='flex flex-col w-full max-w-screen-2xl'>
        <FormHeader title={ isSignUp ? 'Create an account' : 'Welcome back'} description={ isSignUp ? 'Enter your email to sign up for this app' : 'Enter your email to sign in to this app'} showLogo />
        ...
        <main className='flex flex-col items-center justify-center w-full'>
          <div className='flex flex-col w-full md:w-[680px] items-center'>
            ...
            <section className='flex flex-col items-center my-6 gap-y-4 w-full'>
              ...
              : 
              <Button className={buttonStyle} onClick={() => setSeeOtherOptions(!seeOtherOptions)} >See other options</Button> }
            </section>

            <section className='flex flex-col items-center gap-y-6'>
              <p className='text-sm font-light text-[#B3B4B3] text-center'>By clicking continue, you agree to our <Link to="/terms" className='underline'>Terms of Service</Link> and <Link to="/privacy" className='underline'>Privacy Policy</Link></p>
              
              { isSignUp ?
              <p className='text-lg font-light text-[#B3B4B3]'>Already have an account? <Link to="/login" className=' text-gradient'>Log in</Link></p>
              :
              <p className='text-lg font-light text-[#B3B4B3]'>Don't have an account? <Link to="/signup" className=' text-gradient'>Sign up</Link></p>
              }
            </section>
          </div>
        </main>
